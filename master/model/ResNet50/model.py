...
class ResNet50Model(nn.Module):
    ...
    def __init__(self, droprate=0.5, stride=2, returnF=False):
        ...
        self.model = model_ft
        self.returnF = returnF
        # self.classifier_group = {class_list[i]: ClassBlock(2048, numclass_dict[class_list[i]],
        #                                                    droprate, returnF = returnF)
...
class DenseNet121Model(nn.Module):
    ...
    def __init__(self, droprate=0.5, returnF=False):
        ...
        #self.classifier = ClassBlock(1024, class_num, droprate, returnF=returnF)
