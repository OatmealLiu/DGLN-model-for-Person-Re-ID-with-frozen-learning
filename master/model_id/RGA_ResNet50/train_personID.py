...
# Transform learning based on ResNet50 with to-be-learned Relation Global Attention Modules
# Model: load pre-trained ResNet50 and reset final FC and Classifier

# build a person ID codebook for label conversion
# in this way we can obtain the labels of person ID for training
...
# LR Scheduler: decay LR by a factor of 0.1 every 40 epochs
